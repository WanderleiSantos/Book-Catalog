 ...
 */
public class AsyncTaskLoadLancBook  extends BaseAsyncTask<String, Void, List<Book>> {

    private BookAPI bookAPI;

    public AsyncTaskLoadLancBook(Context context, BookAPI bookAPI) {
        super(context);
    ...
    protected AsyncTaskResult<List<Book>> doInBackground(String... params){
        try {
            retrofit.Response<List<Book>> listResponse = bookAPI.getBooksNewest().execute();
